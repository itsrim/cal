...
export const IconBtn = styled.button<{ $isDarkMode: boolean }>`
  border: 1px solid
    ${(p) => (p.$isDarkMode ? "rgba(255, 255, 255, 0.2)" : "#e5e7eb")};
  background: ${(p) =>
    p.$isDarkMode ? "rgba(26, 26, 34, 0.6)" : "rgba(249, 250, 251, 0.8)"};
  ...
  &:hover {
    background: ${(p) =>
      p.$isDarkMode ? "rgba(26, 26, 34, 0.8)" : "rgba(249, 250, 251, 1)"};
...
export const TargetInput = styled.input<{ $isDarkMode: boolean }>`
  ...
  border-radius: 8px;
  border: 1px solid
    ${(p) => (p.$isDarkMode ? "rgba(255, 255, 255, 0.15)" : "#e5e7eb")};
  background-color: ${(p) =>
    p.$isDarkMode ? "rgba(70, 70, 74, 0.6)" : "rgba(255, 255, 255, 0.9)"};
  backdrop-filter: blur(10px);
  -webkit-backdrop-filter: blur(10px);
  color: ${(p) => (p.$isDarkMode ? "#e6e6eb" : "#1a1a1f")};
  font-size: 16px;
